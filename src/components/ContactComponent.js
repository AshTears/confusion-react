...
class Contact extends Component{
	...
	validate(firstname, lastname, telnum, email){
		...
		if(this.state.touched.lastname && lastname.length < 3 || lastname.length > 10){
			errors.firstname = "Last Name should be between 3 and 10 characters"
		}
		const reg = /^\d+$/
		if(this.state.touched.telnum && !reg.test(telnum))
			errors.telnum = "Telephone should contain only digits"
				...
				<div className="col-12 col-md-9">
					<Form onSubmit={this.handleSubmit}>
						<FormGroup row>
							...
							placeholder="Jane" value={this.state.firstname} onChange={this.handleInputChange}
						...
						<FormGroup row>
							...
							<Col md={10}><Input type="text" id="lastname" name="lastname" 
							placeholder="Doe" value={this.state.lastname} onChange={this.handleInputChange}
						...
						<FormGroup row>
							...
							<Col md={10}><Input type="tel" id="telnum" name="telnum" 
							placeholder="5551234567" value={this.state.telnum} onChange={this.handleInputChange}
						...
						<FormGroup row>
							...
							<Col md={10}><Input type="email" id="email" name="email" 
							placeholder="janedoe@mail.com" value={this.state.email} onChange={this.handleInputChange}
						...
						<FormGroup row>
							<Col md={{size:10,offset:2}}><Button type="submit" color="primary">Send Feedback</Button></Col>
						</FormGroup>
					</Form>
				</div>
			</div>
